    ...
    <AnimatePresence>
      {!online ? (
        <motion.div
          ...
          className="fixed inset-x-0 top-0 z-[60] flex items-center justify-center px-4 pt-3"
          role="status"
          aria-live="polite"
          data-testid="offline-banner"
        >
          <div className="inline-flex items-center gap-2.5 rounded-full bg-surface px-3 py-1.5 text-xs tracking-tight text-fg shadow-[0_0_0_1px_var(--color-border),_0_8px_24px_-16px_oklch(0%_0_0_/_0.6)]">
            <span
